export default function PrivacyPolicy() {
    ...
    return (
        <main>
            ...
            <p>
                Balon Mano Plus built the Handball Status app as a Freemium app. This SERVICE is provided by Balon Mano Plus at no cost and is intended for use as is.
                ...
                The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Handball Status unless otherwise 
            ...
            <p>
                For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not 
                limited to Asset information, Other “online identifiers”, Cookie ID. The information that we request will be retained by us and used as 
            ...
            <p>
                We want to inform you that whenever you use our Service, in a case of an error in the app we collect data and information (through third-party products) on 
            ...
            <p>
                ...
                that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.
            </p>
            ...
            <p>
                ...
                not operated by us. Therefore, we strongly advise you to review the Privacy Policy of these websites. We have no control over and assume no responsibility 
            ...
            <p>
                If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at balonmanoplus@gmail.com.
            </p>
        </main>
    )
}